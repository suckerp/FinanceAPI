...
alphavantage.get('/av_price_intra', async (req,res)=>{

    const url = 'https://www.alphavantage.co/query?function=TIME_SERIES_INTRADAY&symbol=MSFT&interval=60min&apikey=JCFTEUU0KSN364KT'
...
alphavantage.get('/av_price_daily', async (req,res)=>{
